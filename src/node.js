...
;(function(global, exports) {
  ...
  // Property name should match string in LoadEnvironment() in src/node.cc.
  exports['internal/bootstrap'] = function(global, process) {
    function startup() {
      ...
      if (NativeModule.exists('_third_party_main')) {
        ...
        if (process._eval != null) {
          ...
          if (global.v8debug &&
            ...
            global.setTimeout(Module.runMain, debugTimeout);
    ...
    startup.processSignalHandlers = function() {
      // Load events module in order to access prototype elements on process
      // like process.addListener.
      var signalWraps = {};
    ...
    startup.preloadModules = function() {
      if (process._preload_modules) {
        NativeModule.require('module')._preloadModules(
